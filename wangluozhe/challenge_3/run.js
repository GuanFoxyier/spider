            ...
            var c = t
                ...
                , B = u.RIPEMD160 = f.extend({
                    ...
                    _doProcessBlock: function (t, r) {
                        ...
                        var f, u, B, w, k, S, m, x, b, H, z = this._hash.words, A = y.words, C = g.words, D = d.words,
                            R = v.words, E = p.words, M = _.words;
                        S = f = z[0],
                            m = u = z[1],
                            x = B = z[2],
                            b = w = z[3],
...
function getSign() {
    var message = "https://wangluozhe.com/challenge/3|" + Date.parse(new Date()).toString();
